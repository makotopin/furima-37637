class PurchaseRecordAddress
  ...
  attr_accessor :user_id, :item_id, :post_code, :region_id, :municipality, :block_number, :building, :phone_number,
  ...
  def save
    ...
    # 住所を保存する
    Address.create(post_code: post_code, region_id: region_id, municipality: municipality, block_number: block_number,
